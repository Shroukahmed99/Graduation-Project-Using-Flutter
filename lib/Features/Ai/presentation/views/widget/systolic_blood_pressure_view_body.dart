...
import 'package:sehatak/core/utils/cache_helper.dart'; // ✅ تمت الإضافة
          ...
          CustomButtom(
            ...
            onTap: () {
              ...
              if (value.isEmpty || double.tryParse(value) == null) {
                customSnackBar(
                    context, 'Please enter a valid systolic pressure');
              } else {
                CacheHelper.saveData(
                    key: 'systolicPressure', value: int.parse(value));

...
class DisplayProfileProviderFormWidget extends StatelessWidget {
  ...
  const DisplayProfileProviderFormWidget({Key? key, this.provider})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            width: double.infinity,
            controller:
                TextEditingController(text: provider?.yearsOfExperience ?? ''),
            enabled: false,
          ),
          CustomTextField(
            title: "Mobile Number",
            width: double.infinity,
            controller:
                TextEditingController(text: provider?.mobileNumber ?? ''),
            enabled: false,
          ),
          CustomTextField(
            title: "Age",
          ...
          CustomTextField(
            ...
            controller: TextEditingController(
                text: provider?.priceRange.toString() ?? ''),
            enabled: false,
          ),

...
class ProfileProviderFormWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child:
          BlocConsumer<UpdateProviderProfileCubit, UpdateProviderProfileState>(
        listener: (context, state) {
          if (state is UpdateProviderProfileSuccess) {
            ...
            GoRouter.of(context)
                .pushReplacement(AppRouter.kSettingProfileProviderView);
                          ...
                          onPressed: () {
                            if (formKey.currentState?.validate() ?? false) {
                              updateCubit.updateProviderProfile(
                                ...
                                priceRange:
                                    int.tryParse(priceRangeController.text) ??
                                        0,
                              );
                            }
                          },
